...
namespace Ds_projekat
{
    public partial class Form1
    {
        private Panel BuildReservationsPage()
        {
            ...
            gbList.Controls.Add(CreateLabel("User", 15, 32));
            cbReservationFilterUser = CreateComboBox("cbReservationFilterUser", 60, 27, 170);
            gbList.Controls.Add(cbReservationFilterUser);

            gbList.Controls.Add(CreateLabel("Date", 245, 32));
            dtpReservationFilterDate = new DateTimePicker();
            dtpReservationFilterDate.Name = "dtpReservationFilterDate";
            dtpReservationFilterDate.Left = 285;
            dtpReservationFilterDate.Top = 27;
            dtpReservationFilterDate.Width = 120;
            dtpReservationFilterDate.Format = DateTimePickerFormat.Short;
            gbList.Controls.Add(dtpReservationFilterDate);

            gbList.Controls.Add(CreateLabel("Location", 420, 32));
            cbReservationFilterLocation = CreateComboBox("cbReservationFilterLocation", 485, 27, 145);
            gbList.Controls.Add(cbReservationFilterLocation);

            lblReservationOccupancy = CreateLabel("Occupancy: -", 15, 58);
            lblReservationOccupancy.AutoSize = true;
            gbList.Controls.Add(lblReservationOccupancy);

            dgvReservations = CreateGrid("dgvReservations", 15, 85, 620, 505);
