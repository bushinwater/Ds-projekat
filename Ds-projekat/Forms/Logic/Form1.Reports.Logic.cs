    ...
    public partial class Form1
    {
        ...
        private void btnExportUsers_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NotifyObservers("Reports", "ExportUsers", "Uspešno je eksportovan users CSV fajl.");
            }
            catch (Exception ex)
            {
                MessageBox.Show(
        ...
        private void btnExportResources_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NotifyObservers("Reports", "ExportResources", "Uspešno je eksportovan resources CSV fajl.");
            }
            catch (Exception ex)
            {
                MessageBox.Show(
        ...
        private void btnExportLocations_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NotifyObservers("Reports", "ExportLocations", "Uspešno je eksportovan locations CSV fajl.");
            }
            catch (Exception ex)
            {
                MessageBox.Show(
        ...
        private void btnExportMemberships_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NotifyObservers("Reports", "ExportMemberships", "Uspešno je eksportovan membership types CSV fajl.");
            }
            catch (Exception ex)
            {
                MessageBox.Show(
        ...
        private void btnExportReservations_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                NotifyObservers("Reports", "ExportReservations", "Uspešno je eksportovan reservations CSV za korisnika ID=" + userId + ".");
            }
            catch (Exception ex)
            {
                MessageBox.Show(
